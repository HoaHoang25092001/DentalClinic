        ...
        <div class="container">
            <div class="left">
                ...
                <form action="MainController" method="POST">
                    <div class="form">
                        <input type="text" class="form-field animation a3" placeholder="Username (Tên tài khoản chứa ít nhất 1 chữ số, VD: hoacute123)" name="userName" pattern="[A-Za-z][1-10].{,10}">
